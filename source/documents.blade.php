    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6 max-w-5xl">
            <div class="relative bg-white p-8 md:p-12 rounded-2xl shadow-xl border border-slate-200 max-w-lg mx-auto">
                <div class="absolute -inset-1 bg-gradient-to-r from-sky-500 to-blue-300 rounded-2xl blur opacity-10"></div>
                
                <div class="relative">
                    <div class="flex justify-center gap-6 mb-6">
                        <!-- Data Payload -->
                        <div class="w-28 h-24 bg-slate-50 border border-slate-200 rounded-lg flex flex-col items-center justify-center shadow-sm">
                            <span class="text-2xl font-mono text-slate-700">{}</span>
                            <span class="text-[10px] font-bold text-slate-500 mt-2 uppercase tracking-wide">App Data</span>
                        </div>
                        <!-- Plus Symbol -->
                        <div class="flex items-center text-slate-300 font-bold text-2xl">+</div>
                        <!-- Template -->
                        <div class="w-28 h-24 bg-slate-50 border border-slate-200 rounded-lg flex flex-col items-center justify-center shadow-sm">
                            <svg class="w-8 h-8 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
                            <span class="text-[10px] font-bold text-slate-500 mt-2 uppercase tracking-wide">Blade / MD</span>
                        </div>
                    </div>
                    
                    <!-- The Engine -->
                    <div class="flex justify-center mb-6 relative">
                        <div class="w-0.5 h-8 bg-slate-300 absolute -top-6"></div>
                        <div class="bg-sky-50 border border-sky-200 text-sky-700 px-6 py-2.5 rounded-full text-xs font-bold shadow-sm z-10 flex items-center gap-2">
                    ...
                    <div class="flex justify-center">
                        <div class="w-40 bg-white border-2 border-slate-200 rounded-lg p-3 flex flex-col items-center shadow-md relative z-10">
                            <div class="w-full h-1.5 bg-slate-200 mb-2 rounded-full"></div>
                            <div class="w-3/4 h-1.5 bg-slate-200 mb-4 rounded-full self-start"></div>
                            <div class="w-full h-20 bg-rose-50 border border-rose-100 rounded flex flex-col items-center justify-center">
                                <svg class="w-6 h-6 text-rose-400 mb-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path></svg>
                                <span class="text-[10px] font-bold text-rose-600 uppercase tracking-wide">Signed Artifact</span>
                            </div>
                        </div>
                    </div>
                </div>
